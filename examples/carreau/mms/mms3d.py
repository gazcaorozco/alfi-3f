...
#                        distribution_parameters=distribution_parameters)
    ...
    def bcs(self, Z):
        bcs = [DirichletBC(Z.sub(0), self.exact_velocity(Z), 1),
               DirichletBC(Z.sub(0), self.exact_velocity(Z), 2),
               DirichletBC(Z.sub(0), self.exact_velocity(Z), 3),
               DirichletBC(Z.sub(0), self.exact_velocity(Z), 4),
               DirichletBC(Z.sub(0), self.exact_velocity(Z), 5),
               DirichletBC(Z.sub(0), self.exact_velocity(Z), 6)]
...
class CarreauMMS3D_Lup(NonNewtonianProblem_Lup):
    def __init__(self, baseN, diagonal=None, **params):
        super().__init__(**params)
        if diagonal is None:
            diagonal = "left"
...
#                        distribution_parameters=distribution_parameters)
    ...
    def bcs(self, Z):
        bcs = [DirichletBC(Z.sub(1), self.exact_velocity(Z), 1),
               DirichletBC(Z.sub(1), self.exact_velocity(Z), 2),
               DirichletBC(Z.sub(1), self.exact_velocity(Z), 3),
               DirichletBC(Z.sub(1), self.exact_velocity(Z), 4),
               DirichletBC(Z.sub(1), self.exact_velocity(Z), 5),
               DirichletBC(Z.sub(1), self.exact_velocity(Z), 6)]
...
class CarreauMMS3D_LSup(NonNewtonianProblem_LSup):
    def __init__(self, baseN, diagonal=None, **params):
        super().__init__(**params)
        if diagonal is None:
            diagonal = "left"
    ...
    def bcs(self, Z):
        bcs = [DirichletBC(Z.sub(2), self.exact_velocity(Z), 1),
               DirichletBC(Z.sub(2), self.exact_velocity(Z), 2),
               DirichletBC(Z.sub(2), self.exact_velocity(Z), 3),
               DirichletBC(Z.sub(2), self.exact_velocity(Z), 4),
               DirichletBC(Z.sub(2), self.exact_velocity(Z), 5),
               DirichletBC(Z.sub(2), self.exact_velocity(Z), 6)]
