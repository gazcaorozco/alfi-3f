...
class Carreau_ldc2d(NonNewtonianProblem_up):
...
class Carreau_ldc2d_Hdiv(NonNewtonianProblem_Lup): #This is ugly, but....
    def __init__(self,baseN,r,nu,eps,tau,diagonal=None,regularised=True):
        super().__init__(r=r,nu=nu,eps=eps,tau=tau)
        if diagonal is None:
            diagonal = "left"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--plots", dest="plots", default=False,
                        action="store_true")
    parser.add_argument("--newtonian", dest="newtonian", default=False,
                        action="store_true")
...
#    taus = [1.]
    ...
    if args.newtonian: r_s = [2.0]
#    #For continuation in r, eps, tau, nu
